...
export const FeedbackSuccessStep = ({onFeedbackRestartRequested}:FeedbackSucessStepProps) =>{
    return(
        <>
        <header>
            <CloseButton/>
        ...
        <div className='flex flex-col items-center py-10 w-[304px]'>
            ...
            <span className="text-xl mt-2">Agradecemos do feedback</span>
            <button 
                type="button"
                className='py-2 px-6 mt-4 bg-zinc-800  rounded-md border-transparent text-sm  leading-6 hover:bg-zinc-700 ocus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-zinc-900 focus:ring-brand-500 transition-colors' 
